            ...
            success: function (response) {
                if (response.code === '200') {
                    ...
                    employees.forEach(function (employee) {
                        employeeTable.append(`
                            <tr data-eid="${employee.eid}">
                                ...
                                <td>${employee.eaddress}</td>
                                <td>${employee.eemail}</td>
                                <td><img src="/assets/${employee.eimage}" alt="Image" width="60" height="60" /></td>
                            </tr>
                        `);
                    });
                    ...
                    $('#employee-table tbody tr').on('click', function () {
                        ...
                        const eaddress = row.find('td:eq(1)').text();
                        const eemail = row.find('td:eq(2)').text();
                        const imageSrc = row.find('td:eq(3)').find('img').attr('src');

                        $('#ename').val(ename);
                        $('#eaddress').val(eaddress);
                        $('#eemail').val(eemail);
                        $('#eimage').val('');
                        $('#image-preview').attr('src', imageSrc).show();
                    });
